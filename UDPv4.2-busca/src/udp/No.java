...
public class No 
{
    ...
    public boolean checaRede ()
    {
       return !((IDsucessor == IDantecessor) &&(IDantecessor== identificador));
    }
    ...
    void buscarNaRede(String IP, int idProcurado) throws UnknownHostException, SocketException, IOException
    {
         // Método para buscar na rede
	
        Lookup(IP,identificador,IPNo,idProcurado);
        Log.add("Buscando pelo ID: "+idProcurado);
    }
