    ...
    void escutaPorta() throws IOException 
    {
        ...
        {    
            ...
            if (msg==1)//Leave
            {
                 ...
                 //short ips0             = (short)(dadosRecebidos[9]+128);
                 //short ips1             = (short)(dadosRecebidos[10]+128);
                 //short ips2             = (short)(dadosRecebidos[11]+128);
                 //short ips3             = (short)(dadosRecebidos[12]+128);    
                 int idAntecessorSaindo = byteArray4ToInt(dadosRecebidos,13);
                 ipa = retornaIP(dadosRecebidos,17); 
                 //short ipa0             = (short)(dadosRecebidos[17]+128);
                 //short ipa1             = (short)(dadosRecebidos[18]+128);
                 //short ipa2             = (short)(dadosRecebidos[19]+128);
                 //short ipa3             = (short)(dadosRecebidos[20]+128); 
            ...
            if (msg==2)//Lookup
            {
                no.Log.add("Recebido lookup "+IPPacoteRecebido);
                 ...
                 //short ip0         = (short)(dadosRecebidos[5]+128);
                 //short ip1         = (short)(dadosRecebidos[6]+128);
                 //short ip2         = (short)(dadosRecebidos[7]+128);
                 //short ip3         = (short)(dadosRecebidos[8]+128);                 
                 ...
                 //If's que alterei para testar com o código do Wancharle. Deu pow!
                 /*if (   
                      ...
                      ((no.identificador <  idProcurado)&&(no.IDsucessor < idProcurado)&&(no.identificador > no.IDsucessor)) ||
                       (no.identificador == no.IDsucessor) && (no.identificador == no.IDantecessor) || 
                        (no.IDantecessor == no.IDsucessor) ) //Só tem 1 nó na rede.
                 {
                 ...
                 {
                     if ((no.IDsucessor < no.identificador) && (no.IDantecessor > no.identificador)){
                         no.RespostaLookup(ip,idProcurado,no.IDsucessor, no.IPsucessor);
                         no.Log.add("FIM DA REDE");
                     }
                     else{
                 ...
                 //O retorno deve ser o proprio nó.
                 if ( ((( no.identificador > idProcurado)&&(no.identificador > no.IDsucessor)&&(idProcurado < no.IDsucessor)) )||
                      ((no.identificador <  idProcurado)&&(no.IDsucessor > idProcurado)) || 
                      ((no.identificador <  idProcurado)&&(no.IDsucessor < idProcurado)&&(no.identificador > no.IDsucessor)) ||
            ...
            if (msg==3)//Update
            {
                no.Log.add("Recebido Update "+IPPacoteRecebido);
                 ...
                 //short ip0          = (short)(dadosRecebidos[9]+128);
                 //short ip1          = (short)(dadosRecebidos[10]+128);
                 //short ip2          = (short)(dadosRecebidos[11]+128);
                 //short ip3          = (short)(dadosRecebidos[12]+128);                   
            ...
            if (msg==64)//Resposta do Join
            {
                ...
                //short ips0         = (short)(dadosRecebidos[5]+128);
                //short ips1         = (short)(dadosRecebidos[6]+128);
                //short ips2         = (short)(dadosRecebidos[7]+128);
                //short ips3         = (short)(dadosRecebidos[8]+128);   
                
                int   idAntecessor = byteArray4ToInt(dadosRecebidos,9);
                ipa = retornaIP(dadosRecebidos,13);
                //short ipa0         = (short)(dadosRecebidos[13]+128);
                //short ipa1         = (short)(dadosRecebidos[14]+128);
                ///short ipa2         = (short)(dadosRecebidos[15]+128);
                ///short ipa3         = (short)(dadosRecebidos[16]+128);   
